...
║                                                           ║
║   Time:  ~10 minutes                                      ║
║   Goal:  Spawn multiple AIs working in parallel           ║
║   Win:   Go from one Claude to an entire AI team          ║
║                                                           ║
╚═══════════════════════════════════════════════════════════╝
```
...
║                                                           ║
║   ~/.noeai/gifts/5-agent-workflows.md                     ║
║                                                           ║
╚═══════════════════════════════════════════════════════════╝
```
...
**👉 Type `/noeai:lesson-5` to continue** 🚀
...
- At the END, tell them to TYPE `/noeai:lesson-5` themselves. Do NOT invoke it via the Skill tool.
